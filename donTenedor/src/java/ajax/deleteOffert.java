 ...
 */
public class deleteOffert extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ctrOffer.destroy(idOffer);
            session.setAttribute("message", "Oferta eliminada correctamente");
        } catch (Exception e) {
            session.setAttribute("message", "Error al eliminar la oferta");
        }
    }
