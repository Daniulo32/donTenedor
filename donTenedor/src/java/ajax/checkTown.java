 ...
 */
public class checkTown extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String poblacion = request.getParameter("localidad");
        ...
        Poblacion pueblo = ctrPoblacion.getPoblacionByNamePoblacion(poblacion);
