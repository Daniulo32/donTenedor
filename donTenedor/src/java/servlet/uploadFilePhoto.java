 ...
 */
public class uploadFilePhoto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String pathUser = user.getName()+user.getSubname()+"-"+user.getIdUser();
        ...
        String uploadFolder = getServletContext().getRealPath("")
                + "images/photoRestaurant/";
        uploadFolder = uploadFolder+pathUser;
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                if (!item.isFormField()) {
                    ...
                    photo.setPhotoRestaurantPK(photoPK);
                    photo.setRestaurant(restaurante);
                    ctrPhoto.create(photo);
